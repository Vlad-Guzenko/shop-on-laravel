...
<ol class="breadcrumb">
    ...
    @if (isset($group_filter))
        <li><a href="{{-- {{route('/admin/filter/group-filter')}} --}}"><i></i>{{$group_filter}}</a></li>
    @endif
    @if (isset($attrs_filter))
        <li><a href="{{-- {{route('/admin/filter/attributes-filter')}} --}}"><i></i>{{$attrs_filter}}</a></li>
    @endif
    @if (isset($currency))
        <li><a href="{{-- {{route('/admin/currency/index')}} --}}"><i></i>{{$currency}}</a></li>
    @endif
